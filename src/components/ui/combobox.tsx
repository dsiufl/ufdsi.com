      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            ...
            className="hover:!translate-y-0 group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent"

          ><ComboboxTrigger className="hover:!translate-y-0 group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent" /></InputGroupButton>
        )}
...
function ComboboxContent({
  ...
  >) {
  return (
    <ComboboxPrimitive.Portal disabled>
