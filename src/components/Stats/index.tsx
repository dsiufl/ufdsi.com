        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="flex flex-col items-center justify-center rounded-xl bg-white p-8 shadow-lg transition-all duration-300 hover:shadow-xl dark:bg-gray-800"
              >
                ...
                <p className="text-center text-base font-medium text-body-color dark:text-gray-300">
                  {stat.label}
                </p>
              </div>
            ))}
