...
const SymposiumSchedule = () => {
  ...
  const openEventModal = (eventName) => {
    const allEventDetails = { ...eventDetails, ...eventDetails2026 };
    setSelectedEvent(allEventDetails[eventName] || {
      title: eventName,
  ...
  const currentSchedule = selectedYear === '2025' ? schedule : schedule2026;
  const currentEventDetails = selectedYear === '2025' ? eventDetails : eventDetails2026;

  return (
    <div className="max-w-6xl mx-auto px-4 pt-24 sm:pt-28 pb-8">
      <div className="mb-6 text-center">
        <div className="mb-2 mt-10">
          <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-900 dark:text-white">DSI Spring Symposium</h1>
          <div className="flex items-center justify-center gap-3 mb-4">
            <label htmlFor="year-select" className="text-base font-medium text-gray-700 dark:text-gray-300">
              Select Year:
            </label>
            <select
              id="year-select"
              ...
              className="px-4 py-2 text-base font-medium border-2 border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-blue-500 dark:focus:border-blue-400 shadow-sm hover:border-gray-400 dark:hover:border-gray-500 transition-colors cursor-pointer"
            >
        ...
        <div className="border rounded-lg shadow-sm bg-white dark:bg-gray-800 p-3 sm:p-4 border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            ...
            <div className="flex items-center gap-2">
              ...
              <p>Date: {selectedYear === '2025' ? 'April 5, 2025' : 'TBA'}</p>
            </div>
            <div className="flex items-center gap-2">
              <svg className="w-4 h-4 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
