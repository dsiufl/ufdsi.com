...
import SpeakerCard from '@/components/symposium-new/SpeakerCard';
...
export default function Client({ selectedYear, symposium, speakers }: { selectedYear: string; symposium: Symposium; speakers: Speaker[] }) {
    const keynoteSpeaker = speakers.find(s => s.id === symposium.keynote) || null;
    ...
    return (
        <div className="min-h-screen  ">
            ...
            {selectedYear === '2026' ? (
                <>
                {/* Speakers Title */}
                <h3 className="text-4xl md:text-5xl text-gray-900 dark:text-white mb-10 text-center" style={{ fontFamily: 'Inter, sans-serif', fontWeight: 300 }}>
                    SPEAKERS
                </h3>
                ...
                {/* Keynote Spotlight */}
                {
                    ...
                    <div className="container mx-auto px-4">
                        <div className="flex flex-col md:flex-row max-w-screen justify-center items-center gap-16 md:gap-24">
                        {
                            speakers.filter(s => s.id !== symposium.keynote).map(speaker => (
                            <div key={speaker.id} className="speaker text-center">
                                <div className="w-56 h-56 lg:w-72 lg:h-72 rounded-full overflow-hidden border-[6px] border-white shadow-xl mx-auto mb-4">
                                <Image
                                    src={speaker.cover}
                                    alt={speaker.name}
                                    width={320}
